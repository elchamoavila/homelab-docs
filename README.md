...
Hello! My name is Alejandro Chavez, and this is the documentation of my journey with my homelab.
...
### FreeBSD VM
- [FreeBSD Installation and DHCP Reservation](./freebsd-vm/01-installation-and-reservation.md)
### Windows Server VM
---
